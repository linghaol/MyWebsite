...
(Once again, more graphs and codes, less words.)
...
<br>
![Architecture Diagram](../static/image/architecture-diagram.svg)<br>
<br>
...
sudo docker run -v mydata:/shared_data linghao/volume
```
...
sudo docker run -d -v mydata:/shared_data --name website
```
...
<br>
![Password Authorization Diagram](../static/image/password_authorization.svg)<br>
<br>
Alright, guys!<br>
